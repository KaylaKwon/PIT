...
public class TLView extends View
{
    ...
    public void SetOurEvents(ArrayList list){
        ourEvents = list;
    }
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        */
        ...
        do
        {
            ...
            canvas.drawLine(x, rulery-100, x, rulery+100, blackline);
            ...
            for (int date = 1; date <= daysthismonth; date++, daynumber++, daymsx += DAY_MILLIS)
            {
                ...
                else if (day_pixels > 170)
                {
                    ...
                    if (daynumber == 1)
                        ...
                        canvas.drawLine(x, rulery - 100, x, rulery, blackline);
        ...
        if (calstuff != null)
        {
            ...
            for (int i = 0; i < calstuff.ourEvents.size(); i++)
            {
                ...
                //Log.e("CHECK", x +" "+ x2);
                Log.e("CHECK", "left = "+ left +" right = "+ right + " dtstart = "+e.dtstart + " dtend = "+e.dtend);
                int y = rulery + 25 + gap;
